...
func distance_two_points_fp{range_check_ptr}(x_1_fp: felt, y_1_fp: felt, x_2_fp: felt, y_2_fp: felt) -> felt {
...
func sine_approx{range_check_ptr}(theta_0_fp: felt, cos_theta_0_fp: felt) -> (sin_theta_0_fp: felt) {
    alloc_locals;
    local range_check_ptr = range_check_ptr;
